 ...
 *
 * lucide-react v1 removed all brand icons (Youtube, Instagram, Facebook), so
 * these are the official simple-icons glyphs, drawn with currentColor so they
 * inherit link hover states like the lucide icons around them.
 */
